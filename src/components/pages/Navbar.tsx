...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-800" style={{  width:"1519px",marginLeft:"-152px",marginTop:"-342px",padding:"8px"}}>
  <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start" style={{marginLeft:"-120px"}}>
      ...
      <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0"style={{marginRight:"-120px"}}>

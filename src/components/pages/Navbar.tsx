...
const Navbar = () => {
  ...
  bg-gray-50 
  text-gray-800
  w-full" style={{width:"1371px",alignContent:"center",marginLeft:"-88px",marginTop:"-255px"}}>
  <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8" flex-row>
    <div className="relative flex h-16 items-center justify-between">
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start" >
        ...
        <div className="hidden sm:ml-6 sm:block gap-x-6">
          <div className="flex space-x-14">
            {/* Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" */}
            <a href="#" className=" About rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Dashboard</a>
            ...
            <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white ">News</a>
          </div>
        </div>
      </div>
      <div className="absolute inset-y-0  right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-2 sm:pr-0 ">
        ...
        <div className="relative ml-3">
          <div>
            <button onClick ={()=> setIsOpen ((prev) => !prev)}type="button" className="relative flex rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-hidden" id="user-menu-button" aria-expanded={isOpen} aria-haspopup="true">
